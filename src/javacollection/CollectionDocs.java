...
public class CollectionDocs {
	 ...
	 * # used to store and processing dynamic multiple data or objects in java.
	 * 
	 * 1. List : dynamic array
	 * 		a. ArrayList : slow processing, better to use for data storage
	 * 		b. LinkedList : fast processing, better to use for data processsing
	 * 
	 * 2. Set : collection of unique data/objects
